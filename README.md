...
void game_introduction(){
	/*介紹遊戲規則:*/
	int tt;
	cout<<"此遊戲叫21點,開局雙方都會抽6張牌,目標是讓我方的手牌到21或跟對方比誰最接近21,開局雙方會抽6張牌"<<endl;
	cout<<"雙方都棄權後開牌;如果雙方與21相差的點數相同則視為平局,須重開一局,一場決勝"<<endl<<endl<<endl<<endl<<endl;
	cout<<"準備好就按7開始:"<<endl;
	cin>>tt;
	if(tt!=7){
		cout<<"此狀態無法執行其他動作"<<endl;
	}
	/*介紹遊戲規則:*/
}
...
int main(){
	...
	string user_name;
	cin>>user_name;
	cout<<"確定選擇此名稱嗎?"<<"(按1確認,按0重新輸入)"<<endl;
	int a=0;
	cin>>a;
	while(a==0){
	cout<<"請輸入玩家名稱 :"<<endl;
